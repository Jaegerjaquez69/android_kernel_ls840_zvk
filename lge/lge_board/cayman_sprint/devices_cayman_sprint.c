...
#include "devices.h"
#include "devices_cayman_sprint.h"
...
static void charm_ap2mdm_kpdpwr_off(void)
{
	...
	if (i == 0
#ifdef CONFIG_MSM_SUBSYSTEM_RESTART //platform-bsp@lge.com : 
	|| charm_boot_mode()//forcing to hard-reset when MDM-ramdump
#endif
	) {
...
//LGSI_ICS_UPDATE_S::<krishnakanth.satpadi@lge.com><2012-JUN-06><Enabled sensor based on LS840 GB><START>
...
#endif
//LGSI_ICS_UPDATE_S::<krishnakanth.satpadi@lge.com><2012-JUN-06><Enabled sensor based on LS840 GB><END>
//[2012-05-21]NFC Porting , addy.kim@lge.com 
#if defined (CONFIG_LGE_WIRELESS_CHARGER_MAX8971) || defined (CONFIG_LGE_WIRELESS_CHARGER_BQ24160) || defined (CONFIG_LGE_NFC_NXP_PN544PN65N)
...
//LGSI_ICS_UPDATE_S::<krishnakanth.satpadi@lge.com><2012-JUN-06><Enabled sensor based on LS840 GB><START>
#if defined (CONFIG_LGE_SENSOR_DCOMPASS)|| defined (CONFIG_LGE_SENSOR_PROXIMITY)
/* Use GSBI10 QUP for /dev/i2c-9 (Sensors) */
...
//[2012-05-21]NFC Porting , addy.kim@lge.com 
#if defined (CONFIG_LGE_WIRELESS_CHARGER_MAX8971) || defined (CONFIG_LGE_WIRELESS_CHARGER_BQ24160) || defined (CONFIG_LGE_NFC_NXP_PN544PN65N)
/* Use GSBI11 QUP for /dev/i2c-12 (wireless charger) */
...
//LGE_BROADCAST SPI START
#ifdef CONFIG_LGE_BROADCAST
static struct resource gsbi11_qup_spi_resources[] = { 
{ 
.name = "spi_base", 
.start = MSM_GSBI11_QUP_PHYS, 
.end = MSM_GSBI11_QUP_PHYS + SZ_4K - 1, 
...
/* Use GSBI11 QUP for SPI-2 */ 
struct platform_device msm_gsbi11_qup_spi_device = { 
.name = "spi_qsd", 
.id = 2, 
.num_resources = ARRAY_SIZE(gsbi11_qup_spi_resources), 
.resource = gsbi11_qup_spi_resources, 
}; 
#endif	//CONFIG_LGE_BROADCAST
//LGE_BROADCAST SPI END
