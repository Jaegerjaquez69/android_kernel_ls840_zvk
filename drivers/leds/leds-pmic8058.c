...
//deukgi.shin@lge.com //20111109 //touch button led off/on early suspend/late resume [S]
#if defined (CONFIG_PM)&&(CONFIG_HAS_EARLYSUSPEND)
#include <linux/earlysuspend.h>
#endif
#include <../../lge/include/board_lge.h>
//deukgi.shin@lge.com //20111109 //touch button led off/on early suspend/late resume [E]
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-09-23, Add LED CONTROL(On/OFF/Blinking) [START]
#include <linux/syscalls.h>
#include <linux/fcntl.h> 
#include <linux/fs.h>
#include <linux/uaccess.h>
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-09-23, Add LED CONTROL(On/OFF/Blinking) [END]
...
int battery_capacity_read(void);
int battery_status_read(char* status);
...
EXPORT_SYMBOL(battery_status_read);

int battery_capacity_read()
{
	int result = 0;
...
EXPORT_SYMBOL(battery_capacity_read);
// LGE_CHANGE [jaekyung83.lee@lge.com] 2011-09-23, Add LED CONTROL(On/OFF/Blinking) [END]
...
/*
	if(0)//lge_bd_rev > LGE_REV_13)
	{
		led_lc_set(&led_data[PMIC8058_ID_LED_2],value);
		return;
	}
*/
//deukgi.shin@lge.com //20111109 //touch button led off/on early suspend/late resume [E]
